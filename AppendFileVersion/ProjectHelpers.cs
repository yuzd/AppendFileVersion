...
namespace AppendFileVersion
{
    internal static class ProjectHelpers
    {
        ...
        public static void AddError(Package package, string errorText)
        {
            ...
            var firstFileInProject = ProjectHelpers.GetSelectedItemPaths(AppenVersionMenuPackage.DTE).FirstOrDefault();
        ...
        {
            Solution2 solution = AppenVersionMenuPackage.DTE.Solution as Solution2;
        ...
        public static string GetRootFolder(Project project = null)
        {
            try
            {
                ...
                {
                    var doc = AppenVersionMenuPackage.DTE.ActiveDocument;
        ...
        public static Project GetActiveProject()
        {
            try
            {
                Array activeSolutionProjects = AppenVersionMenuPackage.DTE.ActiveSolutionProjects as Array;
        ...
        {
            var items = (Array)(dte ?? AppenVersionMenuPackage.DTE).ToolWindows.SolutionExplorer.SelectedItems;
        ...
        {
            var items = (Array)AppenVersionMenuPackage.DTE.ToolWindows.SolutionExplorer.SelectedItems;
            foreach (UIHierarchyItem selItem in items)
            {
        ...
        public static bool CheckOutFileFromSourceControl(string fileName)
        {
            try
            {
                var dte = AppenVersionMenuPackage.DTE;
        ...
        {
            EnvDTE.Solution solution = AppenVersionMenuPackage.DTE.Solution;
        ...
        internal static ProjectItem GetProjectItem(string fileName)
        {
            try
            {
                return AppenVersionMenuPackage.DTE.Solution.FindProjectItem(fileName);
            }
